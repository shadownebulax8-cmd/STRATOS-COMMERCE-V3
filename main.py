...
from stratos_commerce_core.api.v1.analytics import router as analytics_router
...
from stratos_commerce_core.api.v1.websocket_routes import router as websocket_router
